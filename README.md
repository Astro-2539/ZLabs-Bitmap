...
![幻灯片2](https://github.com/user-attachments/assets/d506acb3-1eff-4133-be13-c33f6d13cdd5)

![幻灯片3](https://github.com/user-attachments/assets/46bb82d1-48ea-43bc-89af-741de79c7ddc)

![幻灯片4](https://github.com/user-attachments/assets/88a4e23d-ca0b-489f-ae24-78b86b032962)

![幻灯片5](https://github.com/user-attachments/assets/fb3d4e91-35fe-4484-aeba-e6415455d1e2)

![幻灯片6](https://github.com/user-attachments/assets/c14433b0-e029-430a-90ef-48da34b230ce)


## 字体覆盖范围
| 字符  | 目前支持情况  | 计划支持情况  |
| :------------: | :------------: | :------------: |
|  简体中文 | 目前支持 GB/T 2312 中规定的所有汉字（共6763个），以及《通用规范汉字表》*¹中的部分汉字（7255个）。目前制作完成的字符可满足大多数简体中文用字需求。| 计划支持《通用规范汉字表》*¹中规定的所有汉字。  |
| 繁体中文和日语汉字*²  |  目前制作了部分繁体中文汉字和日语汉字，已覆盖 Big5 常用汉字表、 JIS X 0213 的第一级汉字和多数第二级汉字。 |  未来会支持更多字符。 |
